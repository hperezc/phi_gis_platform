...
import AlarmasLayer from '../AlarmasLayer/AlarmasLayer'
      ...
      {isInitialLoading ? (
        ...
        <>
          ...
          >
            ...
            {/* Integración de la capa de alarmas */}
            {layers.sistema_alarmas && layers.sistema_alarmas.visible && (
              <AlarmasLayer visible={layers.sistema_alarmas.visible} />
            )}
          </MapContainer>
