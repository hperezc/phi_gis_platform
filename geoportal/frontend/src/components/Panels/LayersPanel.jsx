...
const layerIcons = {
  sistema_alarmas: FaExclamationTriangle,
...
const layerDescriptions = {
  sistema_alarmas: {
    description: "Sistema de Alerta Temprana (SAT) que incluye las estaciones de monitoreo y alerta ubicadas estratégicamente en el área de influencia del PHI. Estas estaciones monitorean parámetros hidrológicos y meteorológicos para la detección temprana de eventos extremos.",
    source: "Sistema de Alerta Temprana PHI",
    lastUpdate: "2024",
    category: "Monitoreo y Alerta",
    details: {
      tipo: "Estaciones de monitoreo",
      parametros: ["Nivel de agua", "Precipitación", "Temperatura"],
      cobertura: "Área de influencia PHI"
    }
  },
  departamentos: {
      ...
      <div className="layers-content">
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            ...
            >
              {['senales_evacuacion', 'puntos_encuentro', 'rutas_evacuacion', 'sistema_alarmas'].map(layerId => 
                layers[layerId] && (
                  <LayerItem
                    key={layerId}
                    layer={layers[layerId]}
